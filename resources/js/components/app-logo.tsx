export default function AppLogo() {
    return (
        <>
            <div className="flex aspect-square size-8 items-center justify-center rounded-md bg-white/95 p-1 shadow-sm">
                <img src="/logo-cmk-icon.png" alt="CMK Group" className="size-full object-contain" />
            </div>
